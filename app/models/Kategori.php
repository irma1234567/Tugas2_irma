...
class kategori extends Model
{
      ...
      public function simpan()
      {
            ...
            $sql = "INSERT INTO tb_pelanggan (pel_id_gol,pel_no,pel_nama,pel_alamat,pel_hp,pel_ktp,pel_seri) VALUES (:pel_id_gol,:pel_no,:pel_nama,:pel_alamat,:pel_hp,:pel_ktp,:pel_seri)";
      ...
      public function update()
      {
            ...
            $sql = "UPDATE tb_pelanggan SET pel_nama=:pel_nama,pel_alamat=:pel_alamat,pel_hp=:pel_hp,pel_ktp=:pel_ktp,pel_seri=:pel_seri WHERE pel_id=:pel_id";
            $stmt = $this->db->prepare($sql);
            $stmt->bindParam(":pel_nama", $pel_nama);
            $stmt->bindParam(":pel_alamat", $pel_alamat);
            $stmt->bindParam(":pel_hp", $pel_hp);
